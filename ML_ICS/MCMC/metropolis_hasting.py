...
class MetropolisHastings:
    ...
    def posterior_probability(self,
        ...
        print('Parameter Array: ',parameter_array)

        initial_condition_guess=s.predict(parameter_array.reshape(1,-1))
        print('ML model results: ',initial_condition_guess)


        spin_calculations = evolution(self.interpolator,
                                      parameter_set,
                                      initial_condition_guess,
