...
class MetropolisHastings:
    ...
    def posterior_probability(self,parameter_set=None):
        ...
        try:
            ...
            print("Error in spin calculations:")
            print (str(e))
            return scipy.nan
    ...
    def reject_parameter(self):
        """reject any unphysical parameter set"""
    ...
    def first_iteration(self):
        """Draws the first set of parameters and calulates corresponding posterior
        probability. This process will run until a non-zero, non-nan value of
        posterior probability is calculated. Parameters that gives zero or nan
        values will be rejected and updated in rejected_parameters file"""
    ...
    def iterations(self):
        ...
        while True:
            ...
            #initialising the current set of parameters
            if self.iteration_step == 1 : self.first_iteration()

            #Prpose new values using the proposal function. The values will be
            #proposed again if a negative age is encountere. The parameter set
            #with negative age is rejected and updated in rejected_parameters
            #file
            ...
            #calculating posterior probabilty for proposed values. A nan value
            #for posterior will mean the mass calculations were out of range of
            #the interpolator. In that case new values will be proposed and
            #rejected values will be updated in rejected_parameters file.
            ...
            #To calculate time taken for a each iteration
            ...
            #write the parameters on corresponding accepted or rejected file and
            #save the mose recent accepted parameter set
            self.write_output()
...
if __name__ == '__main__':
    ...
    observation_data = dict(
                        ...
                        mass_primary=dict(value=5922.0, sigma=200.0),
                        feh=dict(value=-0.06, sigma=0.11),
                        porb=dict(value=0.0,sigma=0.0),
                        rvk=dict(value=0.0, sigma=0.0)
                        angle_inclination=dict(value=0.0, sigma=0.0)
    ...
    proposed_step = dict(
                        age_step=2.0,
                        mass_priamry_step=0.10,
                        feh_step=0.1,
                        porb_step=0.1,
                        rvk_step=0.2,
                        angle_inclination_step=0.1
                        Wdisk_step=0.1,
                        logQ_step=0.2
                    )
