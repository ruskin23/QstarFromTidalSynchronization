...
class InitialConditionSolver:
    ...
    def _try_initial_conditions(self, initial_condition):
        ...
        #print(orbital_period-self.target.Porb, eccentricity-self.target.eccentricity)
    ...
    def __call__(self, target, primary, secondary):
        ...
        #sol = optimize.root(self._try_initial_conditions,[5.66,0.1],method='lm')
        #print(sol.x)


        Porb = [6.00,5.90,5.80,5.70,5.66,5,50]
        for p in Porb:
            initial_condition=[p,0.2]
