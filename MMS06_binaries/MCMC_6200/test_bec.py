...
class evolution:
    ...
    def __init__(self,interpolator,parameter_set,instance):
    ...
    def __call__(self):
        ...
        target = Structure(age=self.age,
                           ...
                           Wdisk=self.Wdisk,
                           eccentricity=self.eccentricity# initial disk locking frequency
                            )
...
if __name__ == '__main__':
    ...
    parameters = dict(age=4.6,
                      ...
                      secondary_mass=0.83740*1.0232841210154926,
