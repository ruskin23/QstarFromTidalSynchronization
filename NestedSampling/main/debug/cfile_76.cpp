 ...
 ******************************************************************************/
/* Physical properties */
const double PRIMARY_MASS = 7.7544004996523608e-01;
const double FEH = 8.5332563137871853e-02;
...
/* Dissipation */
#if 1
    const double PRIMARY_PHASE_LAG = 1.5710606574451242e-07;
 ...
 ******************************************************************************/
const double SECONDARY_MASS = 6.7013529117995696e-01;
...
/* Dissipation */
#if 1
    const double SECONDARY_PHASE_LAG = 1.5710606574451242e-07;
 ...
 * INITIAL ORBIT                                                              *
 ******************************************************************************/
const double INITIAL_SEMIMAJOR = 2.6377809984026278e+01;
const double DISK_FREQUENCY = 2.0578606788042060e+00;
const double DISK_DISSIPATION_AGE = 5.0000000000000001e-03;
const double INITIAL_INCLINATION = 0.0000000000000000e+00;
const double INITIAL_ECCENTRICITY = 4.3626383928761842e-01;
/******************************************************************************/
...
int main(int, char **)
{
    read_eccentricity_expansion_coefficients(
        "/home/ruskin/projects/poet/eccentricity_expansion_coef.txt"
    );
    ...
    OrbitSolver *solver = evolve_system(
        system,
        7.5862595812964928e+00,
        1.0000000000000000e-02,
        1.0000000000000001e-05,
        NULL,   //required ages
        0,      //num required ages
        true,
        0    //Print stepping progress?
    );
