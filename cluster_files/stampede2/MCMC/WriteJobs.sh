...
do
	for B in 1 2 3 4 5 
	do
		echo "python3 /work/06850/rpatel23/stampede2/QstarFromTidalSynchronization/MCMC/combined/main.py -c -i $B -l $A >"/scratch/06850/rpatel23/output/$A.$B.'$LAUNCHER_TSK_ID.out' 
	done
done >NonSyncJob1
