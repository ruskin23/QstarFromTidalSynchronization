...
do
    ...
    do
        echo "python3 /home/rxp163130/QstarFromTidalSynchronization/MCMC/combined/main.py -c -i $B -l $A -m uncorrelated >/home/rxp163130/scratch/eleventh_run/$A.$B.out"
    done
done >uncorrelated
...
#    do
#        echo "python3 /home/rxp163130/QstarFromTidalSynchronization/MCMC/combined/main.py -c -i $B -l $A -p $B -m uncorrelated >/home/rxp163130/scratch/eleventh_run/$A.$B.out" >> uncorrelated
#    done
#done 
