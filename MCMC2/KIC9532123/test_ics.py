...
class InitialConditionSolver:
    ...
    def _try_initial_conditions(self, initial_condition):
        ...
        print(self.orbital_period-self.target.Porb,
              self.eccentricity-self.target.eccentricity)
    ...
    def __call__(self, target, primary, secondary):
        ...
        sol = optimize.root(
                            ...
                            [target.Porb,target.eccentricity],
                            method='lm'
                            )
        ...
        return(sol.x,self.orbital_period,self.eccentricity,spin)
