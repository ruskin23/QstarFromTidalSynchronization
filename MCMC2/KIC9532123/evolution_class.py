...
class evolution:
    ...
    def __call__(self):
        ...
        ic,current_porb,current_e,spin =  find_ic(target=target,
                       primary=primary,
                       secondary=secondary)


        with open('stellar_spin_vs_logQ','a') as f:
            f.write(repr(self.logQ) + '\t' + 'spin' + '\t' + repr(ic[0]) + '\t'
...
if __name__ == '__main__':
    ...
    with open('stellar_spin_vs_logQ','w') as f:

        f.write('logQ' + '\t' + 'stellar_spin' + '\t' + 'initial_Porb' + '\t' + 'initial_eccentricity' + '\t' + 'current_Porb' + '\t' + 'current_e' + '\n')


    logQ = numpy.arange(6.0,24.0,0.5)
