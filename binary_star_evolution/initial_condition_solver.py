...
class InitialConditionSolver:
    ...
    def __call__(self, target, primary, secondary):
        ...
        evolution=self.binary.get_evolution()

        with shelve.open('InitialConditionsFrequencies.shelve','c') as Frequencies:
            Frequencies['age']=evolution.age
            Frequencies['wenv_secondary']=(evolution.secondary_envelope_angmom / self.binary.secondary.envelope_inertia(evolution.age)) / wsun
            Frequencies['wcore_secondary']=(evolution.secondary_core_angmom / self.binary.secondary.core_inertia(evolution.age)) / wsun
            Frequencies['wenv_primary'] = (evolution.primary_envelope_angmom / self.binary.primary.envelope_inertia(evolution.age)) / wsun
            Frequencies['wcore_primary'] = (evolution.primary_core_angmom / self.binary.primary.core_inertia(evolution.age)) / wsun
            Frequencies['orbitalfrequncy'] = self.binary.orbital_frequency(evolution.semimajor) / wsun
