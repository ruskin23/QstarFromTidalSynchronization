 ...
 ******************************************************************************/
/* Physical properties */
const double PRIMARY_MASS = 7.8694486280619491e-01;
const double FEH = -8.9558885420630041e-01;
...
/* Dissipation */
#if 1
    const double PRIMARY_PHASE_LAG = 2.2663839958840343e-09;
    ...
    double PRIMARY_TIDAL_FREQUENCY_POWERS[] =
        {-1.2000000000000000e+00, -1.2000000000000000e+00};
 ...
 ******************************************************************************/
const double SECONDARY_MASS = 5.2174444404050724e-01;
...
/* Dissipation */
#if 1
    const double SECONDARY_PHASE_LAG = 2.2663839958840343e-09;
 ...
 * INITIAL ORBIT                                                              *
 ******************************************************************************/
const double INITIAL_SEMIMAJOR = 1.9111592820642329e+01;
const double DISK_FREQUENCY = 1.2000000000000000e+00;
const double DISK_DISSIPATION_AGE = 5.0000000000000001e-03;
const double INITIAL_INCLINATION = 0.0000000000000000e+00;
const double INITIAL_ECCENTRICITY = 4.2000000000000003e-02;
/******************************************************************************/
...
EvolvingStar *create_primary()
{
    MESAInterpolator *primary_interpolator = load_interpolator(
        "/home/kpenev/projects/git/poet/stellar_evolution_interpolators/f18f8304-fa82-4fe1-b082-43bbf8131cae"
    );
...
EvolvingStar *create_secondary()
{
    ...
    double initial_secondary_angmom[] = {
        1.2126886494264628e-01,
        5.9038960243208987e-04
    };
...
int main(int, char **)
{
    read_eccentricity_expansion_coefficients(
        "/home/ruskin/projects/QstarFromTidalSynchronization/binary_star_evolution/eccentricity_expansion_coef.txt"
    );
