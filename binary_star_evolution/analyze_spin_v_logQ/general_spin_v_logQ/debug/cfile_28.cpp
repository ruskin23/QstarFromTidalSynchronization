 ...
 ******************************************************************************/
/* Physical properties */
const double PRIMARY_MASS = 1.0212468596976731e+00;
const double FEH = 1.0904848569999481e-01;
...
/* Dissipation */
#if 1
    const double PRIMARY_PHASE_LAG = 2.9841551829730377e-05;
 ...
 ******************************************************************************/
const double SECONDARY_MASS = 8.5243475378964773e-01;
...
/* Dissipation */
#if 1
    const double SECONDARY_PHASE_LAG = 2.9841551829730377e-05;
 ...
 * INITIAL ORBIT                                                              *
 ******************************************************************************/
const double INITIAL_SEMIMAJOR = 3.3167942872983822e+01;
const double DISK_FREQUENCY = 1.0999999999999996e+00;
const double DISK_DISSIPATION_AGE = 5.0000000000000001e-03;
const double INITIAL_INCLINATION = 0.0000000000000000e+00;
const double INITIAL_ECCENTRICITY = 2.0872893925803221e-01;
/******************************************************************************/
...
EvolvingStar *create_secondary()
{
    ...
    double initial_secondary_angmom[] = {
        1.3106279956881286e+00,
        1.7753567728695459e-02
    };
