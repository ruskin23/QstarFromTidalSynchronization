 ...
 ******************************************************************************/
/* Physical properties */
const double PRIMARY_MASS = 9.8726316165313577e-01;
const double FEH = 1.1863142610967389e-01;
...
/* Dissipation */
#if 1
    const double PRIMARY_PHASE_LAG = 1.6338124854890828e-06;
 ...
 ******************************************************************************/
const double SECONDARY_MASS = 7.5969900289208792e-01;
...
/* Dissipation */
#if 1
    const double SECONDARY_PHASE_LAG = 1.6338124854890828e-06;
 ...
 * INITIAL ORBIT                                                              *
 ******************************************************************************/
const double INITIAL_SEMIMAJOR = 2.5902648153361834e+01;
const double DISK_FREQUENCY = 2.3176032732523346e+00;
const double DISK_DISSIPATION_AGE = 5.0000000000000001e-03;
const double INITIAL_INCLINATION = 0.0000000000000000e+00;
const double INITIAL_ECCENTRICITY = 4.3325745042908692e-01;
/******************************************************************************/
...
EvolvingStar *create_secondary()
{
    ...
    double initial_secondary_angmom[] = {
        6.1777387363656122e-01,
        8.6670944812541049e-04
    };
