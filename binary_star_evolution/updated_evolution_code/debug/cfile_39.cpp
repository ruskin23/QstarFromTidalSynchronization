 ...
 ******************************************************************************/
/* Physical properties */
const double PRIMARY_MASS = 1.0571084005376594e+00;
const double FEH = -4.2635982503045389e-01;
...
/* Dissipation */
#if 1
    const double PRIMARY_PHASE_LAG = 3.6995126626106429e-12;
 ...
 ******************************************************************************/
const double SECONDARY_MASS = 6.4060769072582158e-01;
...
/* Dissipation */
#if 1
    const double SECONDARY_PHASE_LAG = 3.6995126626106429e-12;
 ...
 * INITIAL ORBIT                                                              *
 ******************************************************************************/
const double INITIAL_SEMIMAJOR = 2.4436222742696209e+01;
const double DISK_FREQUENCY = 4.3333656623686583e+00;
const double DISK_DISSIPATION_AGE = 5.0000000000000001e-03;
const double INITIAL_INCLINATION = 0.0000000000000000e+00;
const double INITIAL_ECCENTRICITY = 8.2537099038995670e-02;
/******************************************************************************/
...
EvolvingStar *create_secondary()
{
    ...
    double initial_secondary_angmom[] = {
        7.1122711544420103e-01,
        7.2279919157083646e-03
    };
...
int main(int, char **)
{
    read_eccentricity_expansion_coefficients(
        "/home/ruskin/projects/QstarFromTidalSynchronization/binary_star_evolution/updated_evolution_code/eccentricity_expansion_coef.txt"
    );
