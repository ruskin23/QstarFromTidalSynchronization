 ...
 ******************************************************************************/
/* Physical properties */
const double PRIMARY_MASS = 8.8668911087065261e-01;
const double FEH = -4.0474480499155618e-01;
...
/* Dissipation */
#if 1
    const double PRIMARY_PHASE_LAG = 1.7954381071138007e-07;
 ...
 ******************************************************************************/
const double SECONDARY_MASS = 7.6627672961441795e-01;
...
/* Dissipation */
#if 1
    const double SECONDARY_PHASE_LAG = 1.7954381071138007e-07;
 ...
 * INITIAL ORBIT                                                              *
 ******************************************************************************/
const double INITIAL_SEMIMAJOR = 1.6530252901131657e+01;
const double DISK_FREQUENCY = 3.0203206488519649e+00;
const double DISK_DISSIPATION_AGE = 5.0000000000000001e-03;
const double INITIAL_INCLINATION = 0.0000000000000000e+00;
const double INITIAL_ECCENTRICITY = 4.2089338234323992e-01;
/******************************************************************************/
...
EvolvingStar *create_secondary()
{
    ...
    double initial_secondary_angmom[] = {
        6.5030163730070734e-01,
        4.0900420603191219e-02
    };
